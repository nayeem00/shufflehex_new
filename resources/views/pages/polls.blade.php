...
@section('content')
    <div class="box">
        <div class="row box-header">
            <div class="col-md-12"><h3>Polls</h3></div>
        </div>
        <?php
...
@section('js')
    ...
    <script>
        $( document ).ready(function() {
            $("#latest_stories").attr("href", "{{ url('/post/latest/polls') }}");
            $("#top_stories").attr("href", "{{ url('/post/top/polls') }}");
            $("#popular_stories").attr("href", "{{ url('/post/popular/polls') }}");
            $("#trending_stories").attr("href", "{{ url('/post/trending/polls') }}");
        });
