...
@section('content')
    ...
    <div class="single-story-body">
        <div class="story-heading">
            <h1>{{ $post->title }}</h1>
            <p><span class="small" style="color: #999999">Submitted by <strong>{{ $post->username }}</strong> at {{ $date }} in <strong>{{ $post->category }}</strong></span></p>
        </div>
    ...
    <div class="box about-author">
        <div class="box-header">
            ...
            <div class="pull-right">
                <a class="btn btn-danger"  href="#">Donate Me</a>
            </div>
        </div>
        <div class="pa-15">
            <div class="author">
