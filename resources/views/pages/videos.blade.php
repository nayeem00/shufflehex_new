...
@section('content')
    <div class="box">
        <div class="row box-header">
            <div class="col-md-12"><h3>Videos</h3></div>
        </div>
        <?php
...
@section('js')
    <script>
        $( document ).ready(function() {
            $("#latest_stories").attr("href", "{{ url('/post/latest/videos') }}");
            $("#top_stories").attr("href", "{{ url('/post/top/videos') }}");
            $("#popular_stories").attr("href", "{{ url('/post/popular/videos') }}");
            $("#trending_stories").attr("href", "{{ url('/post/trending/videos') }}");
        });
