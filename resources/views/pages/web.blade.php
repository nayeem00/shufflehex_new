...
@section('content')
    <div class="box">
        <div class="row box-header">
            <div class="col-md-12"><h3>Web Links</h3></div>
        </div>
<?php
...
@section('js')
    ...
    <script>
        $( document ).ready(function() {
            $("#latest_stories").attr("href", "{{ url('/post/latest/web') }}");
            $("#top_stories").attr("href", "{{ url('/post/top/web') }}");
            $("#popular_stories").attr("href", "{{ url('/post/popular/web') }}");
            $("#trending_stories").attr("href", "{{ url('/post/trending/web') }}");
        });
