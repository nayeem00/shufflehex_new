...
@section('content')
    <div class="box" >
        <div class="row box-header">
            <div class="col-md-12"><h3>Images</h3></div>
        </div>
        <?php
...
@section('js')
    ...
    <script>
        $( document ).ready(function() {
            $("#latest_stories").attr("href", "{{ url('/post/latest/images') }}");
            $("#top_stories").attr("href", "{{ url('/post/top/images') }}");
            $("#popular_stories").attr("href", "{{ url('/post/popular/images') }}");
            $("#trending_stories").attr("href", "{{ url('/post/trending/images') }}");
        });
