...
@section('js')
    ...
    <script>
        $( document ).ready(function() {
            $("#latest_stories").attr("href", "{{ url('/post/latest/articles') }}");
            $("#top_stories").attr("href", "{{ url('/post/top/articles') }}");
            $("#popular_stories").attr("href", "{{ url('/post/popular/articles') }}");
            $("#trending_stories").attr("href", "{{ url('/post/trending/articles') }}");
        });
