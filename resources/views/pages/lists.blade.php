...
@section('js')
    ...
    <script>
        $( document ).ready(function() {
            $("#latest_stories").attr("href", "{{ url('/post/latest/lists') }}");
            $("#top_stories").attr("href", "{{ url('/post/top/lists') }}");
            $("#popular_stories").attr("href", "{{ url('/post/popular/lists') }}");
            $("#trending_stories").attr("href", "{{ url('/post/trending/lists') }}");
        });
