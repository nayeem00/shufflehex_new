    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar">
                ...
                <form class="navbar-form navbar-search navbar-right" role="search" style="margin-left: auto">
                    <div class="form-group">
                        <input type="text" class="fontAwesome form-control" placeholder="&#xf002; Discover New Content">
                    </div>
                </form>
