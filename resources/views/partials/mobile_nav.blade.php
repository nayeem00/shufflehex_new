                            ...
                            @if (Auth::guest())
                                <a class="user-no-img" href="{{ url('/login') }}">
                                    <img class="img-circle"
                                         src="@if (!empty(Auth::user()->mini_profile_picture_link)) {{url(Auth::user()->mini_profile_picture_link)}} @else {{ asset( 'images/user/profilePicture/default/mini_user.png') }} @endif" alt="Login">
                                </a>
                            @else
